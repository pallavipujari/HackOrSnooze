...
class StoryList {
  ...
  static async getStories() {
   ...
   // console.log(response.data.stories);
    ...
    //response.data.stories is array of stories 
  ...
  async removeStory(storyId,user){
    ...
    const resp= axios.delete(`${BASE_URL}/stories/${storyId}`,{data:{token:user.loginToken,username:user.username}});
...
//To retrieve current updated user data ,to populate correctly while changing tabs 
  async getUser(){
